...
const modernHouseImageUrl =
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRG7frREuKlFshj327rzfrDr4jxRqqjhPXE7Q&s';

//root page: At "Live anywhere -> Unique Stays"
const uniqueLakeCabinImageUrl =
'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRhWT-H8ZD5NJdAyZqH-4cLLRlcjt5aODKA6A&s';
//root page: At "Live anywhere -> Pets Allowed"
const dogBeingLovedImageUrl =
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRjnGBIvZwOr5vSFB4-gh4DH7tuCtAHGHM-TA&s';

//root page: At "Experience the world -> Online Experiences"
const elderlyCoupleTabletImageUrl =
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS51Atly_Z71q76C7w2NkQJjc9pXkvozK8brQ&s';

//root page: At "Experience the world -> Experiences"
const couplePotteryImageUrl =
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSpIhMawn1rHt02dx9XwHA0-jWqThZ4Jzw7FQ&s';

//root page: At "Experience the world -> Adventures"
const womanCliffImageUrl =
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTv-om1X_vYl4L80Kn_LJzy_bQRqHmw-tAnbw&s';

//root page: At "Explore Nearby -> Dallas"
const cityImageUrl =
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQdevEYWQkBSpqP1dQnQycht3uqtGNN_DqVxA&s';

//root page: At "Explore Nearby -> Austin"
const scooterImageUrl =
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRA3Nz09klvCdOpGdMUkDuek47iugFHMu3ciA&s';

//root page: At "Explore Nearby -> Glaveston"
const beachImageUrl =
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSEazibjvQEofhApBW72TheZUwEWlySHZBq_Q&s';

//root page: At "Explore Nearby -> Broken Bow/ HotSprings"
const lakeImageUrl =
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRe0K52U1fQnoqCoCi4ho3a0__NeRKuLvE1Fg&s';

//root page: At "Explore Nearby -> Canyon Lake"
const waterfallImageUrl =
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcShyDKFGKFK3SyUZ1zQ8B7AZNHOp9k9ibLgPg&s';

const locationImageUrl =
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcShyDKFGKFK3SyUZ1zQ8B7AZNHOp9k9ibLgPg&s';
const fireplaceImageUrl =
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRO1WITjQfu6qYJTCZGKu6JwAof7TDavliUeA&s';
...
class SavedScreen extends StatelessWidget {
  const SavedScreen({required this.savedLists, super.key});
